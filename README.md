...
Everything here is built using **NumPy**.

---

## Projects

### 1. Macroeconomic Shock Simulator
...
* **The Lesson:** It was a reality check on "Alpha." It’s a lot harder to read about trading than it is to actually beat a random market.
...
*Currently working on a Markowitz Portfolio Optimizer to add next.*
